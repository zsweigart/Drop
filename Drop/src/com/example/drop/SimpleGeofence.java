...
public class SimpleGeofence {
    ...
    /**
     * @param geofenceId The Geofence's request ID (which we will set as the Note object id)
     ...
     * @param radius Radius of the geofence circle in meters. The value is not checked for validity
